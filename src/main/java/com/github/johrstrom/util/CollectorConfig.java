...
// * collectors. It holds an array of labels for a given collector and the methods
// * to access SamplerResult and AssertionResult.
// * 
...
//
//	/**
//	 * Get an array of all the Methods to use when updating the Collector.
//	 * 
